...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'talents_page', 'language',
                      self.gf('slim.models.fields.LanguageField')(default='pt-br', max_length=10),
                      keep_default=False)

        # Adding field 'Page.translation_of'
        db.add_column(u'talents_page', 'translation_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='translations', null=True, to=orm['talents.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.language'
        db.delete_column(u'talents_page', 'language')

        # Deleting field 'Page.translation_of'
        db.delete_column(u'talents_page', 'translation_of_id')
