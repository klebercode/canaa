...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'talents_talent', 'translation_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='translations', null=True, to=orm['talents.Talent']),
                      keep_default=False)
    ...
    models = {
        ...
        u'talents.talent': {
            ...
            'translation_of': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'translations'", 'null': 'True', 'to': u"orm['talents.Talent']"})
        }
    }
